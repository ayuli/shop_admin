    ...
    <div class="leftsidebar_box">
        ...
        <dl class="system_log">
            <dt>
                ...
                <img class="icon2" src="../img/coin04.png" /> 定时器
            ...
            <dd>
                ...
                <a class="cks" href="/setinterval" target="main">定时器</a>
        ...
        <dl class="system_log">
            ...
            <dd>
                <img class="coin11" src="../img/coin111.png" />
                <img class="coin22" src="../img/coin222.png" />
                <a href="/index/usershow" target="main" class="cks">用户管理</a>
                <img class="icon5" src="../img/coin21.png" />
            </dd>
            <dd>
                <img class="coin11" src="../img/coin111.png" />
                <img class="coin22" src="../img/coin222.png" />
                <a href="/index/record/list" target="main" class="cks">用户浏览商品记录</a>
                <img class="icon5" src="../img/coin21.png" />
            </dd>
        </dl>
        <dl class="system_log">
        ...
        <dl class="system_log">
            ...
            <dd>
                <img class="coin11" src="../img/coin111.png" />
                <img class="coin22" src="../img/coin222.png" />
                <a href="/qrcode/show" target="main" class="cks">二维码用户展示</a>
                <img class="icon5" src="../img/coin21.png" />
            </dd>
            <dd>
                <img class="coin11" src="../img/coin111.png" />
                <img class="coin22" src="../img/coin222.png" />
                <a href="/ordershow" target="main" class="cks">微信支付列表</a>
                <img class="icon5" src="../img/coin21.png" />
            </dd>
        </dl>
        <dl class="system_log">
            <dt>
                ...
                系统管理<img class="icon3" src="../img/coin19.png" />
                <img class="icon4" src="../img/coin20.png" />
            </dt>
            <dd>
